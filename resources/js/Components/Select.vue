...
<template>
    <select class="block w-full pl-3 pr-10 py-2 transition duration-100 ease-in-out border rounded-md
        ...
        <option v-for="(item, key) in options" :value="item.value">{{ item.name }}</option>
    </select>
</template>
